...
export default function PilotFormModal({ open, onClose, onSubmit }) {
  ...
  const handlePilotSubmit = async (e) => {
    try {
      ...
      const payload = {
        source: "pilot",
        selectedPlan: null, // keep null for pilot
        ...payloadForm,
        meta: {
      ...
      console.log("Submitting pilot interest:", payload);
      ...
      setSubmitting(false);
      onClose?.();
      console.log("Pilot submitted:", data);
    } catch (error) {
      setSubmitting(false);
    ...
    <div
      ...
      <div className="relative w-full max-w-xl bg-white rounded-xl shadow-lg">
        <div className="flex items-center justify-between px-5 py-4 border-b">
          <h3 className="m-0 text-lg font-semibold">Start 30 Day Pilot</h3>
          <button
            aria-label="Close"
            onClick={onClose}
